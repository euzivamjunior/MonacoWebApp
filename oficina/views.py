...
def formulario(request):
    if request.method == 'POST':
        ...
        form = Formulario.objects.create(ano_veiculo=ano_veiculo, marca_veiculo=marca_veiculo,
                                         modelo_veiculo=modelo_veiculo, servicos=servicos,
                                         comentarios=comentarios, data_do_agendamento=date,
                                         tipo_contato=tipo_contato, nome=nome,
                                         sobrenome=sobrenome, cpf=cpf, telefone=telefone,
                                         email=email)
